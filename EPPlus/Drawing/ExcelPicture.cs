...
namespace OfficeOpenXml.Drawing
{
    ...
    {
        private static readonly ImageCodecInfo[] CodecInfos = ImageCodecInfo.GetImageEncoders();
        ...
        internal static ImageCodecInfo GetImageCodecInfo(Image image)
        {
            foreach (var info in CodecInfos)
                if (image.RawFormat.Guid == info.FormatID)
                    return info;
...
#endif
            var ii = _drawings._package.AddImage(img, GetImageCodecInfo(image));
        ...
        /// Image format
        /// </summary>
        public ImageFormat ImageFormat { get { return Image?.RawFormat; } }
