...
namespace OfficeOpenXml
{
    public class ExcelVBAProject
    {
        ...
        public ExcelVBAProject(ExcelWorkbook wb)
        {
            ...
            var rel = _wb.Part.GetRelationshipsByType("http://schemas.microsoft.com/office/2006/relationships/vbaProject").FirstOrDefault();
            if (rel != null)
            {
        ...
        {
            var rel = Part.GetRelationshipsByType("http://schemas.microsoft.com/office/2006/relationships/vbaProjectSignature").FirstOrDefault();
            if (rel != null)
            {
                var uri = PackUriHelper.ResolvePartUri(rel.SourceUri, rel.TargetUri);
                var part = _pck.GetPart(uri);
        ...
        public void SignProject()
        {
            ...
            byte[] myCmsMessage = Verifier.Encode();            
        }
    }
}
