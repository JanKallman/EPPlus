    ...
    public class ExcelWorksheet : XmlHelper, IEqualityComparer<ExcelWorksheet>, IDisposable
    {
		...
		public void InsertRow(int rowFrom, int rows, int copyStylesFromRow)
        {
            ...
            lock (this)
            {
                ...
                // issue #256
                UpdateDrawingsPositionRow(rowFrom, rows);
        ...
        public void InsertColumn(int columnFrom, int columns, int copyStylesFromColumn)
        {
            ...
            lock (this)
            {
                ...
                // issue #256
                UpdateDrawingsPositionCol(columnFrom, columns);
        ...
        /// <summary>
        /// Updates the row position of affected drawings
        /// </summary>
        /// <param name="start">The index of the row of the update</param>
        /// <param name="cnt">The number of rows inserted or deleted</param>
        /// <param name="del">Are rows inserted or deleted</param>
        private void UpdateDrawingsPositionRow(int start, int cnt, bool del = false)
        {
            var mod = cnt * (del ? -1 : 1);
            foreach (ExcelDrawing dr in Drawings.Where(dr => dr.From.Row >= start && dr.EditAs != eEditAs.Absolute))
            {
                dr.From.Row += mod;
                dr.To.Row += mod;
            }
        ...
        /// <summary>
        /// Updates the column position of affected drawings
        /// </summary>
        /// <param name="start">The index of the column of the update</param>
        /// <param name="cnt">The number of columns inserted or deleted</param>
        /// <param name="del">Are columns inserted or deleted</param>
        private void UpdateDrawingsPositionCol(int start, int cnt, bool del = false)
        {
            var mod = cnt * (del ? -1 : 1);
            foreach (ExcelDrawing dr in Drawings.Where(dr => dr.From.Column >= start && dr.EditAs != eEditAs.Absolute))
            {
                dr.From.Column += mod;
                dr.To.Column += mod;
            }
        ...
        public void DeleteRow(int rowFrom, int rows)
        {
            ...
            lock (this)
            {
                ...
                // issue #256
                UpdateDrawingsPositionRow(rowFrom, rows, true);
        ...
        public void DeleteColumn(int columnFrom, int columns)
        {
            ...
            lock (this)
            {
                ...
                // issue #256
                UpdateDrawingsPositionCol(columnFrom, columns, true);
