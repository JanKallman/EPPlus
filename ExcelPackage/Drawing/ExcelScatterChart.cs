...
namespace OfficeOpenXml.Drawing
{
    public class ExcelScatterChart : ExcelChart
    {
        ...
        {
           /***** ScatterStyle *****/
           if(ChartType == eChartType.xlXYScatter ||
              ChartType == eChartType.xlXYScatterLines ||
              ChartType == eChartType.xlXYScatterLinesNoMarkers)
           {
               ScatterStyle = eScatterStyle.LineMarker;
           }
           else if (
              ChartType == eChartType.xlXYScatterSmooth ||
              ChartType == eChartType.xlXYScatterSmoothNoMarkers) 
           {
