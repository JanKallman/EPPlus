...
namespace EPPlusTest
{
    ...
    public class WorkSheetTest : TestBase
    {
        ...
        [TestMethod]
        public void LoadFromCollectionWithEnumTest()
        {
            var ws = _pck.Workbook.Worksheets.Add("LoadFromCollection");
            List<TestDTO> list = new List<TestDTO>();
            list.Add(new TestDTO() { Id = 1, Name = "Item 1", Boolean = false, Date = new DateTime(2011, 1, 1), dto = null, NameVar = "Field 1", Enum = TestEnum.Item1 });
            list.Add(new TestDTO() { Id = 1, Name = "Item 2", Boolean = false, Date = new DateTime(2012, 1, 1), dto = null, NameVar = "Field 2", Enum = TestEnum.Item2 });
            list.Add(new TestDTO() { Id = 1, Name = "Item 3", Boolean = false, Date = new DateTime(2013, 1, 1), dto = null, NameVar = "Field 3", Enum = null });

            ws.Cells["A1"].LoadFromCollection(list, true);

            Assert.AreEqual("Item I", ws.Cells["F2"].Value);
            Assert.AreEqual("Item2", ws.Cells["F3"].Value);
            Assert.IsNull(ws.Cells["F4"].Value);
        }
